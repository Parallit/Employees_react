        ...
        <>
            ...
            <div className={style.content_wrp}>
                <div className={style.description_wrp}>
                    <p className={style.description}>This project was created by using React and ExpressJS for the backend, includes JWT Tokens authentication and MongoDB database</p>
