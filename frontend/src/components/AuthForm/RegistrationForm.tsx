...
import { userRegistration } from "../../store/auth/authSlice";
            ...
            <div className={style.login_wrp}>
                ...
                <form onSubmit={handleSubmit}>
                    <div className={style.user_wrp}>
                        <input onChange={e => setName(e.target.value)} value={name} className={style.user_input} type="text" id="name" required />
                        <label htmlFor="name" className={style.user_label}>Name: </label>
                    </div>
                    <div className={style.user_wrp}>
                        <input onChange={e => setEmail(e.target.value)} value={email} className={style.user_input} type="text" id="email" required />
                        <label htmlFor="email" className={style.user_label}>Email: </label>
                    </div>
                    <div className={style.user_wrp}>
                        <input onChange={e => setPassword(e.target.value)} value={password} className={style.user_input} type="password" id="password" required />
                        <label htmlFor="password" className={style.user_label}>Password: </label>
                    </div>
