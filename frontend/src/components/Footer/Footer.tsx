        ...
        <>
            <div className={style.container}>
                ...
                <div className={style.footer_copyright}>
                    <p>Copyright &copy; {new Date().getFullYear()} All rights reserved | This project is made with &#10084; by 
                        <a className={style.footer_link} href="https://github.com/Parallitik"> Parallitik</a>
                    </p>
                </div>
            </div>
