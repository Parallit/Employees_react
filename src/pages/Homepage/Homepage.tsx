  ...
  return (
    <>
      ...
      <Container>
        ...
        <Text>
          This project allows you to create cards for employees of your
          department, edit them and delete the entered information.
        </Text>
        <Text>
          Information on all employees is presented in the form of a reference
          book.
        </Text>
      </Container>
    </>
